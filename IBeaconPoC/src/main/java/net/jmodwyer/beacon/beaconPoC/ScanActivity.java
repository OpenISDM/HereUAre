...
SensorEventListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        //SensorActivity Sensor = null;
        //Sensor.onCreate(savedInstanceState);
        ...
        mSensorManager = (SensorManager) getSystemService(SENSOR_SERVICE); //getsensorservice
        sensor = mSensorManager.getDefaultSensor(Sensor.TYPE_ORIENTATION);//setup Sensor
